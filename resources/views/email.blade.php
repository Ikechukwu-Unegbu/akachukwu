...
<body style="background-color: #e5e7eb; margin: 0; padding: 20px; font-family: Arial, sans-serif;">
    <div style="max-width: 400px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); overflow: hidden;">
        ...
        <div style="text-align: center; padding: 24px;">
            <img src="{{asset('images/vastel-logo.svg')}}" alt="Vastel Logo" width="80" style="display: block; margin: 0 auto;">
        </div>
        
        <!-- Main Content -->
        <div style="padding: 24px; color: #1f2937;">
            <h1 style="font-size: 20px; font-weight: 600; text-align: center; color: #0018A8; margin-bottom: 16px;">Welcome to Vastel</h1>
            ...
            <p style="font-size: 14px; font-weight: 600; margin-bottom: 16px;">Let's make things easier together!</p>
