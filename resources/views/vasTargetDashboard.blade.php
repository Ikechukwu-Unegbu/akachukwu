        ...
        <section class="p-6">
            ...
            <div class="flex gap-6 border border-[#00000038] rounded-2xl bg-[#E6E6E640] p-4">
              ...
              <div class="grid grid-cols-3 gap-4">
                <div class="flex flex-col rounded-xl border  border-[#00000036] w-fit px-3 py-3 pr-14 text-sm text-[#333333]">
                     ...
                     <div class="flex flex-col gap-1">
                        <div class="flex justify-center items-center rounded-2xl bg-[#D9D9D963] w-12 h-12">
                            <svg width="21" height="29" viewBox="0 0 21 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3 28.25C2.3125 28.25 1.72396 28.0052 1.23438 27.5156C0.744792 27.026 0.5 26.4375 0.5 25.75V12C0.5 11.3125 0.744792 10.724 1.23438 10.2344C1.72396 9.74479 2.3125 9.5 3 9.5H6.75V12H3V25.75H18V12H14.25V9.5H18C18.6875 9.5 19.276 9.74479 19.7656 10.2344C20.2552 10.724 20.5 11.3125 20.5 12V25.75C20.5 26.4375 20.2552 27.026 19.7656 27.5156C19.276 28.0052 18.6875 28.25 18 28.25H3ZM9.25 19.5V5.53125L7.25 7.53125L5.5 5.75L10.5 0.75L15.5 5.75L13.75 7.53125L11.75 5.53125V19.5H9.25Z" fill="#3346B9"/>
                                </svg>
                     ...
                     <div class="flex flex-col gap-1">
                        <div class="flex justify-center items-center rounded-2xl bg-[#D9D9D963] w-12 h-12">
                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4.875 9.25C3.66667 9.25 2.63542 8.82292 1.78125 7.96875C0.927083 7.11458 0.5 6.08333 0.5 4.875C0.5 3.66667 0.927083 2.63542 1.78125 1.78125C2.63542 0.927083 3.66667 0.5 4.875 0.5C6.08333 0.5 7.11458 0.927083 7.96875 1.78125C8.82292 2.63542 9.25 3.66667 9.25 4.875C9.25 6.08333 8.82292 7.11458 7.96875 7.96875C7.11458 8.82292 6.08333 9.25 4.875 9.25ZM4.875 6.75C5.39583 6.75 5.83854 6.56771 6.20312 6.20312C6.56771 5.83854 6.75 5.39583 6.75 4.875C6.75 4.35417 6.56771 3.91146 6.20312 3.54688C5.83854 3.18229 5.39583 3 4.875 3C4.35417 3 3.91146 3.18229 3.54688 3.54688C3.18229 3.91146 3 4.35417 3 4.875C3 5.39583 3.18229 5.83854 3.54688 6.20312C3.91146 6.56771 4.35417 6.75 4.875 6.75ZM16.125 20.5C14.9167 20.5 13.8854 20.0729 13.0313 19.2188C12.1771 18.3646 11.75 17.3333 11.75 16.125C11.75 14.9167 12.1771 13.8854 13.0313 13.0313C13.8854 12.1771 14.9167 11.75 16.125 11.75C17.3333 11.75 18.3646 12.1771 19.2188 13.0313C20.0729 13.8854 20.5 14.9167 20.5 16.125C20.5 17.3333 20.0729 18.3646 19.2188 19.2188C18.3646 20.0729 17.3333 20.5 16.125 20.5ZM16.125 18C16.6458 18 17.0885 17.8177 17.4531 17.4531C17.8177 17.0885 18 16.6458 18 16.125C18 15.6042 17.8177 15.1615 17.4531 14.7969C17.0885 14.4323 16.6458 14.25 16.125 14.25C15.6042 14.25 15.1615 14.4323 14.7969 14.7969C14.4323 15.1615 14.25 15.6042 14.25 16.125C14.25 16.6458 14.4323 17.0885 14.7969 17.4531C15.1615 17.8177 15.6042 18 16.125 18ZM2.25 20.5L0.5 18.75L18.75 0.5L20.5 2.25L2.25 20.5Z" fill="#3346B9"/>
                                </svg>
