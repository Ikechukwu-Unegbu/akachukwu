<div class="">
    <div class="pt-2 profile-overview">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8">{{ $transactionDetails?->plan_network }} {{ $transactionDetails?->data_type->name }} Data</div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8">{{ $transactionDetails?->size }} - {{ $transactionDetails?->validity }}</div>
        </div>
        <div class="row">
