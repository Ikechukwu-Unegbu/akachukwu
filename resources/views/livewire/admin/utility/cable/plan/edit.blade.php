<div>
    <x-admin.page-title title="Utilities">
        ...
        <x-admin.page-title-item subtitle="Edit Cable Plan" status="true" />
    </x-admin.page-title>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="p-0 m-0 card-title">
                        {{ $vendor->name }} ({{ $cable->cable_name }} - {{ $plan->package }})
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row">
                ...
                <div class="card-footer">
                    <div class="text-center">
                        <a href="{{ route('admin.utility.cable.plan', [$vendor->id, $cable->id]) }}" class="btn btn-md btn-danger" wire:loading.remove wire:target="update">
...
@push('title')
Utilities / Cable TV / Edit - Cable Plan
@endpush