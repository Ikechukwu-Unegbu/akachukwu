<div>
    <x-admin.page-title title="Utilities">
        ...
        <x-admin.page-title-item subtitle="Airtime" />
        ...
        <div class="card">
            <div class="card-header m-1 p-2">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title">{{ $vendor->name }} Vendor <br> <small>Set Discounts for Airtime Networks</small></h5>
                    
                    <div><a href="{{ route('admin.utility.airtime') }}?vendor={{ $vendor->id }}"
            ...
            <form wire:submit='update'>
                ...
                <div class="card-footer">
                    <div class="text-right">
                        <a href="{{ route('admin.utility.airtime') }}?vendor={{ $vendor->id }}" class="btn btn-md btn-danger" wire:loading.remove wire:target="update">
