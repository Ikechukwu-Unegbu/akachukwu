<div wire:ignore.self id="transfer-modal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            @if ($transferMethod === 1)
                <form
                    wire:submit="@if ($recipient) handleMoneyTransfer @else handleVerifyRecipient @endif">
                    <!-- Modal body -->
            ...
            @if ($transferMethod === 2)
                <form class="px-3" wire:submit="{{ $handleMethodAction['method'] }}">
                    ...
                    <div class="text-center p-6 {{ ($transactionStatusModal || $vastelTransactionStatus) ? 'hidden' : '' }}">
