    ...
    <section class="section">
        ...
        <form action="{{route('admin.site.update')}}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{$setting->stie_title}}" class="form-control" id="site_title"
                    name="site_title">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="{{$setting->address_one}}" id="address_one"
                    name="address_one">
            </div>
            <div class="mb-3">
                <label for="address_two" class="form-label">Address 2</label>
                <input type="text" class="form-control" value="{{$setting->address_two}}" id="address_two"
                    name="address_two">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="{{$setting->total_users}}" id="total_users"
                    name="total_users">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" value="{{$setting->airtime_limit}}" id="airtime_limit"
                    name="airtime_limit">
            </div>
            <div class="mb-3">
                <label for="transfer_charges" class="form-label">Money Transfer Charges</label>
                <input type="number" class="form-control" value="{{$setting->transfer_charges}}" id="transfer_charges"
                    name="transfer_charges">
            </div>
            <div class="mb-3">
                <label for="minimum_transfer" class="form-label">Minimum Transfer Amount</label>
                <input type="number" class="form-control" value="{{$setting->minimum_transfer}}" id="minimum_transfer"
                    name="minimum_transfer">
            </div>
            <div class="mb-3">
                <label for="single_transfer_limit" class="form-label">Single Transfer Limit</label>
                <input type="number" class="form-control" value="{{$setting->single_transfer_limit}}" id="single_transfer_limit"
                    name="single_transfer_limit">
            </div>
            <div class="mb-3">
                <label for="maximum_transfer" class="form-label">Maximum Daily Transfer</label>
                <input type="number" class="form-control" value="{{$setting->maximum_transfer}}" id="maximum_transfer"
                    name="maximum_transfer">
            </div>
            <div class="mb-3">
                <label for="card_charges" class="form-label">Percent Charge on Card Funding</label>
                <input type="text" class="form-control" value="{{$setting->card_charges}}" id="card_charges"
                    name="card_charges">
            </div>
            <div class="mb-3">
