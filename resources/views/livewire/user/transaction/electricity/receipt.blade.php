<div>
    <div class="tm_pos_invoice_wrap" id="tm_download_section">
        <div class="tm_pos_invoice_top">
            ...
            <div class="tm_pos_company_mobile">{{ $electricity->transaction_id }}</div>
        </div>
        <div class="tm_pos_invoice_body">
            <div class="tm_pos_invoice_heading"><span>Electricity Receipt</span></div>
            <ul class="tm_list tm_style1">
                <li class="d-flex justify-content-between">
                    <div class="tm_list_title">Disco:</div>
                    <div class="text-right tm_list_desc">{{ $electricity->disco_name }}</div>
                </li>
                
                <li class="d-flex justify-content-between">
                    <div class="tm_list_title">Meter:</div>
                    <div class="text-right tm_list_desc">{{ $electricity->meter_number }}</div>
                </li>

                <li class="d-flex justify-content-between">
                    <div class="tm_list_title">Meter Type:</div>
                    <div class="text-right tm_list_desc">{{ $electricity->meter_type_name }}</div>
                </li>
                ...
                <li class="d-flex justify-content-between">
                    <div class="tm_list_title">Customer Phone:</div>
                    <div class="text-right tm_list_desc">{{ $electricity->customer_mobile_number }}</div>
                </li>                

                <li class="d-flex justify-content-between">
                    <div class="tm_list_title">Customer Address:</div>
                ...
                <li class="d-flex justify-content-between">
                    ...
                    <div class="text-right tm_list_desc"> {{ $electricity->created_at->format('M d, Y. h:i a') }}</div>
                </li>
            </ul>
