<div>
    <div class="tm_pos_invoice_wrap" id="tm_download_section">
        <div class="tm_pos_invoice_top">
            ...
            <div class="tm_pos_company_mobile">{{ $airtime->transaction_id }}</div>
        </div>
        <div class="tm_pos_invoice_body">
            <div class="tm_pos_invoice_heading"><span>Airtime Receipt</span></div>
            <ul class="tm_list tm_style1">
                <li class="d-flex justify-content-between">
                    <div class="tm_list_title">Phone:</div>
                    <div class="text-right tm_list_desc">{{ $airtime->mobile_number }}</div>
                </li>
                
                <li class="d-flex justify-content-between">
                    <div class="tm_list_title">Network:</div>
                ...
                <li class="d-flex justify-content-between">
                    ...
                    <div class="text-right tm_list_desc"> {{ $airtime->created_at->format('M d, Y. h:i a') }}</div>
                </li>
            </ul>
