        ...
        <section class="lg:border border-[#00000038] lg:my-8 lg:py-5  mt-8 py-4 lg:w-6/12 ">
            ...
            <section class="mt-8 lg:mt-10 ml-4 lg:ml-10 mr-4">
                ...
                <div class="rounded-2xl bg-[#E6E6E65C] p-3 w-full  border-2 border-[#E6E8F6C9] mb-4">
                        ...
                        <span class="text-[#333333] flex gap-2 font-semibold">
                            ...
                            <a href="{{ route('vasSave') }}" class="items-center flex justify-center">
                                <svg width="7" height="11" viewBox="0 0 7 11" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 0.833415L5.66667 5.50008L1 10.1667" stroke="black" stroke-width="1.58333"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                    ...
                    <p class="text-[#333333] bg-[#E6E8F6D9] pl-2 rounded-xl py-1 mt-3 text-sm  ">Save whenever you want,
                        withdraw anytime</p>
                </div>
                ...
                <div class="rounded-2xl bg-[#E6E6E65C] p-3 w-full  border-2 border-[#E6E8F6C9] mb-4">
                    ...
                    <p class="text-[#333333] bg-[#E6E8F6D9] pl-2 rounded-xl py-1 mt-3 text-sm">Save towards a specific goal
                        over time</p>
                </div>
                ...
                <div class="rounded-2xl bg-[#E6E6E65C] p-3 w-full  border-2 border-[#E6E8F6C9]">
                    ...
                    <p class="text-[#333333] bg-[#E6E8F6D9] pl-2 rounded-xl py-1 mt-3 text-sm">Lock funds for a set period
                        and earn higher return</p>
                </div>
            </section>
        </section>
