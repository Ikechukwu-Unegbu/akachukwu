...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
  ...
  <div class="bg-white rounded-lg p-6 shadow-md max-w-sm w-full text-center">
    <!-- Status Icon -->
    <div class="flex items-center justify-center w-[10rem] h-[10rem] rounded-full">
        @php
        ...
        @elseif($apiResponse && $apiResponse->Status == 'failed')
        <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex space-x-4 mt-6">
      ...
      @php
    // Get the model name without 'Transaction' and convert to lowercase
