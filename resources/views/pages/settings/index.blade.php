    ...
    <div id="transferModal" tabindex="-1"
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                @else
                <form action="{{ route('reseller-upgrade') }}" method="POST">
                    @csrf
                    <!-- Modal body -->
                    <div class="p-6 space-y-6 text-center">
                    ...
                    <div class="flex justify-between p-6">
                        ...
                        <button type="submit" class="text-white bg-vastel_blue focus:ring-4 focus:outline-none focus:ring-blue-600 font-medium rounded-lg text-sm px-5 py-2.5">
                            Continue
                        </button>
                    </div>
                </form>
