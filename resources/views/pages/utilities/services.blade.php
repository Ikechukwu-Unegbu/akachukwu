...
<!-- <div class="bg-gray-100 p-4 md:p-8"> -->
    <div class=" bg-white rounded-lg  p-6">
        ...
        <div class="grid grid-cols-3 sm:grid-cols-5 gap-4">
            ...
            <a href="{{ route('savings') }}" class="flex flex-col w-[100%] md:w-[60%] rounded-[10px] shadow-lg  p-5 md:p-2 items-center">
                <div class="w-12 h-12  flex items-center justify-center">
                    <i class="fas fa-piggy-bank text-vastel_blue text-3xl"></i>
                </div>
                <span class="font-semibold text-vastel_blue text-xs text-center">savings</span>
            </a>
        </div>
    </div>
<!-- </div> -->
