...
@section('body')
    ...
    <section class=" bg-white text-center px-4 py-12  bg-gray-50 md:px-[3rem]">
        <div class=" flex flex-row items-center justify-center gap-5 px-4">
            <div class="">
            <div class="">
                <h2 class="text-3xl text-b
                 font-semibold mb-4">About Vastel</h2>
    ...
    <!-- Who We Are Section -->
    <section class="px-4 py-12  md:px-[3rem]">
        <div class="flex flex-row-reverse justify-center items-center gap-10  mx-auto px-4">
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div class="flex items-center">
                    <div>
                        <h3 class="text-2xl font-semibold text-vastel_blue mb-4">Our Vision</h3>
                ...
                <div>
                    <img src="{{asset('images/vision.png')}}" alt="Vision Image" class="rounded-lg shadow-lg object-cover h-64 w-full">
                </div>

                <!-- Why Choose Us? -->
                <div>
                    <img src="{{asset('images/why.png')}}" alt="Why Choose Us Image" class="rounded-lg shadow-lg object-cover h-64 w-full">
                </div>
                <div class="flex items-center">
                    <div>
                        ...
                        <ul class="text-lg text-gray-600 space-y-4">
                            ...
                            <li><strong>Rewards:</strong> Earn points and rewards for every transaction and refer friends to earn even more.</li>
                        </ul>
                    </div>
                </div>
            </div>
