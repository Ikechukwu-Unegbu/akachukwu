        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="">
                        <a href="{{ route('admin.bank.create') }}" class="btn btn-secondary"><i
                                class="bi bi-arrow-left-circle"></i> Bank List</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('admin.bank.update', $bank->id) }}" class="mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="ussd_template" name="ussd_template"
                            value="{{ $bank->ussd_template }}">
                    </div>

                    <div class="mb-3">
                        <label for="base_ussd_code" class="form-label">Base USSD Code</label>
                        <input type="text" class="form-control" id="base_ussd_code" name="base_ussd_code"
                            value="{{ $bank->base_ussd_code }}">
                    </div>

                    <div class="mb-3">
                        <label for="transfer_ussd_template" class="form-label">Transfer USSD Template</label>
                        <input type="text" class="form-control" id="transfer_ussd_template" name="transfer_ussd_template"
                            value="{{ $bank->transfer_ussd_template }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nip_bank_code" name="nip_bank_code"
                            value="{{ $bank->nip_bank_code }}">
                    </div>

                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" name="va_status" @checked($bank->va_status)>
                            <label class="form-check-label" for="flexSwitchCheckChecked">Virtual Account Status</label>
                        </div>
                    </div>

                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" name="status" @checked($bank->status)>
