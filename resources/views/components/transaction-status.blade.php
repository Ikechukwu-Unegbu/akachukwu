        ...
        <div class="relative dark:bg-gray-700 rounded-lg shadow">
            ...
            <div class="px-6 py-6 lg:px-8">
                <div class="flex flex-col items-center">
                    ...
                    <h3 class="text-lg font-semibold mb-1 text-gray-200">Transaction {{ $status ? 'Successful' : 'Failed' }}</h3>
                    <p class="text-gray-200 text-sm mb-4">{{ $utility }} Purchased {{ $status ? 'Successfully' : 'Failed' }}</p>
                    @if (!empty($link))
