    ...
    <div class="flex flex-col lg:flex-row min-h-screen">
        ...
        <div class="flex flex-col justify-center w-full lg:w-1/2 p-6 lg:p-12 bg-white">
            <div class="max-w-md mx-auto">
                ...
                <p class="text-gray-600 mb-6">Create an account so you can pay and purchase top-ups faster.</p>
                <form>
                    <div class="mb-4 relative">
                        <i class="fas fa-user absolute left-3 top-3 text-gray-400"></i>
                        <input type="text" placeholder="Username" class="pl-10 w-full p-3 border border-gray-300 rounded">
                    </div>
                    <div class="mb-4 relative">
                        <i class="fas fa-envelope absolute left-3 top-3 text-gray-400"></i>
                        <input type="email" placeholder="Email" class="pl-10 w-full p-3 border border-gray-300 rounded">
                    </div>
                    <div class="mb-4 relative">
                        <i class="fas fa-phone absolute left-3 top-3 text-gray-400"></i>
                        <input type="tel" placeholder="Phone Number" class="pl-10 w-full p-3 border border-gray-300 rounded">
                    </div>
                    <div class="mb-4 relative">
                        <i class="fas fa-lock absolute left-3 top-3 text-gray-400"></i>
                        <input type="password" placeholder="Password" class="pl-10 w-full p-3 border border-gray-300 rounded">
                    </div>
                    <div class="mb-4 relative">
                        <i class="fas fa-lock absolute left-3 top-3 text-gray-400"></i>
                        <input type="password" placeholder="Confirm Password" class="pl-10 w-full p-3 border border-gray-300 rounded">
                    </div>
                    <div class="mb-4 relative">
                        <i class="fas fa-user-plus absolute left-3 top-3 text-gray-400"></i>
                        <input type="text" placeholder="Referral (Optional)" class="pl-10 w-full p-3 border border-gray-300 rounded">
                    </div>
                    <button type="submit"
                        class="w-full bg-blue-600 text-white py-3 rounded hover:bg-blue-700">Continue</button>
                    <p class="mt-4 text-gray-600">Have an account? <a href="#"
                            class="text-blue-600 hover:text-blue-800">Click here to login</a></p>
                </form>
                <div class="mt-6">
