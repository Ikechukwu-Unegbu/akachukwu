...
<div class="flex min-h-screen  md:px-[6rem] py-[2rem] gap-[2rem] bg-gray-100">
    ...
    <div class="w-full md:w-[50%] bg-white p-8 shadow-lg">
        ...
        <form method="POST" action="{{route('login')}}" onsubmit="handleFormSubmission(event)">
            @csrf
            @include("components.error_message")
            <div class="relative mb-6">
                <input type="text" id="username" required name="username" placeholder=" " class="floating-label-input block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
            ...
            <div class="relative mb-6">
                <input type="password" id="password" required name="password" placeholder=" " class="floating-label-input block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
