...
<body class="bg-white font-sans">
    <div class="flex flex-col md:flex-row h-screen">
        <!-- Sidebar -->
        <nav class="bg-indigo-700 text-white w-full hidden md:w-16 lg:w-64 md:flex flex-row md:flex-col justify-between md:justify-start ">
            ...
            <div class="flex md:flex-col space-x-4 md:space-x-0 md:space-y-6">
                <a href="#" class="flex items-center bg-white bg-opacity-20 rounded-lg p-2">
        ...
        <main class="flex-1 overflow-y-auto">
            <!-- Header -->
            <header class="flex justify-between bg-white items-center mb-8 py-[5px] border-b border-b-4 h-[5rem] px-[2rem]">
