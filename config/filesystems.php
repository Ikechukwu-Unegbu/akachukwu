...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'webhooks' => [
            'driver' => 'local',
            'root' => storage_path('app/public/webhooks'),
            'url' => env('APP_URL').'/storage/webhooks',
            'visibility' => 'public',
            'throw' => false,
        ],
        ...
        'do' => [
            ...
            'bucket' => config('services.digitalocean.bucket'),
            'url'    => config('services.digitalocean.url'),
            'endpoint' => config('services.digitalocean.endpoint'),
            'use_path_style_endpoint' => config('services.digitalocean.use_path_style', true),
            'throw' => false,
